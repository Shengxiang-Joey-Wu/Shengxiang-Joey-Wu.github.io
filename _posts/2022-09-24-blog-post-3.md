...
To avoid confusion, I have replaced activation energy $E_a$ with free energy of activation $\Delta G$, and the subscript $c$ and $a$ stands for cathode (where reduction happens) and anode (where oxidation happens) respectively.
