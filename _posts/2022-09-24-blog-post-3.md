...
where $C_\mathrm{Ox}$ and $C_\mathrm{Red}$ are the concentrationsa of $\mathrm{Ox}$ and $\mathrm{Red}$ species. The potential evaluated in Nernst equation is also a thermodynamics property, but it turns out also affecting the reaction rates through the transition state theory (Fig. 1): the ratio between $\mathrm{Ox}$ and $\mathrm{Red}$ species alters the relative position of $\mathrm{Ox}$ (A) and $\mathrm{Red}$ (B) in the potential energy surface, therefore, it also alters the activation energies felt by $\mathrm{Ox}$ and $\mathrm{Red}$ (will explained in detail below). 
