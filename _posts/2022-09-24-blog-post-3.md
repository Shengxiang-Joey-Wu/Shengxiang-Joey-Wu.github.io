...
Since the redox reactions usually involve electron transfer, it wouldn't hurt if we first study the electron transfer process in general (Fig. 2). The most general scenario is the one electron transfer process that reduces $\mathrm{Ox_1}$ to its reductive form $\mathrm{Red_1}$.
