...
$$k_f=A_f\exp(-\Delta G_c/RT)=A_f\exp(-\Delta G_c^0/RT)\exp[-\alpha F(E-E^0)]=k_f^0\exp[-\alpha F(E-E^0)]=k^0\exp[-\alpha F(E-E^0)]=$$

$$k_b=A_b\exp(-\Delta G_a/RT)=A_b\exp(-\Delta G_a^0/RT)\exp[(1-\alpha) F(E-E^0)]=k_b^0\exp[-(1-\alpha) F(E-E^0)]=k^0\exp[-(1-\alpha) F(E-E^0)]$$
