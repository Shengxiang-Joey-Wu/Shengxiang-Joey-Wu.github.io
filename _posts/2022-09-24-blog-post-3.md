...
where $k_f$ and $k_b$ are obtained from eq. 11 and eq. 12 at each applied potential. The total faradaic current that corresponds to each time increment is finally calculated as:
