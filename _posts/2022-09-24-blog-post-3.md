...
In most cases, there is a 'hill' that reactant A needs to surpass before forming product B even the reaction is energetic favorable $(\Delta_rG<0)$. The peak of the 'hill' is usually represented by a transition state (TS), and we can therefore define activation energies for forward $(E_{a,f})$ and backward $(E_{a,b})$. reactions.

<p align="center">
<img src="http://ShengxiangWuPlasmonic.github.io/images/Blog_3_Fig_3.jpg" width="292">
</p>
...
where $A$ is a pre-exponential factor, it contains everything that we don't know (lol) about rate constant and ideally it should be temperature-insensitive. One can imagine that the rate constant is greater (reaction is faster) if activation energy is smaller or temperature is higher.
***
